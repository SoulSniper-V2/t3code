...
export const THREAD_DETAILS_PANEL_ROW_CLASS = `h-9 w-full min-w-0 justify-start rounded-lg border-transparent bg-transparent ${THREAD_DETAILS_PANEL_ROW_CONTENT_CLASS} text-[13px] font-medium text-foreground/80 sm:h-9 sm:text-[13px] ${THREAD_DETAILS_PANEL_ROW_SURFACE_CLASS}`;
...
export const THREAD_DETAILS_PANEL_SPLIT_PRIMARY_CLASS = `h-9 min-w-0 flex-1 justify-start rounded-e-none border-transparent bg-transparent ${THREAD_DETAILS_PANEL_ROW_CONTENT_CLASS} pr-2 text-[13px] font-medium text-foreground/80 sm:h-9 sm:text-[13px] ${THREAD_DETAILS_PANEL_SPLIT_BUTTON_SURFACE_CLASS}`;
