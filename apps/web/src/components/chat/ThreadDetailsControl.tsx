...
const parts = {
  ...
  checks: `h-8 gap-1.5 rounded-[var(--control-radius)] border-transparent px-[calc(--spacing(2.5)-1px)] text-sm font-medium text-foreground/80 sm:h-7 ${THREAD_DETAILS_PANEL_SPLIT_BUTTON_SURFACE_CLASS}`,
